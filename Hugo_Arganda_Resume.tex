...
\item{Leading multidisciplinary and multicultural teams (30+ headcount)}
\item{Development team distributed in 3 different locations: USA, Egypt and India}
\item{Primary point of contact for Software-related topics}
\item{V-cycle development process}
\item{ASPICE (SWE, MAN, and SUP)}
\end{itemize-bullets}
}
...
{Reporting, Scrum (Scrum Master, Product Owner), CMMI, MS Project, Jira, Confluence, Rally}
